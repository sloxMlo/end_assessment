    ...
    $village = trim($_POST['village'] ?? '');
        ...
        if ($count > 0) {
            ...
            if ($stmt->execute()) {
                ...
                header("refresh:3;url=vhw_home.php");
                exit();
            } else {
...
<dev class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
        ...
        <form class="border shadow p-3 rounded" action="patiant_register2.php" method="post" style="width: 450px; background-color: white;">
        <h1 class="display-5 fw-bold" style="text-align: center;color:#00006B;font-family:Times New Roman;">Register Your Patient</h1>
